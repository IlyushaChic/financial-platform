module github.com/IlyushaChic/financial-platform/tests

go 1.26.3

replace github.com/IlyushaChic/financial-platform/backend/auth-service => ../backend/auth-service

replace github.com/IlyushaChic/financial-platform/backend/shared => ../backend/shared
